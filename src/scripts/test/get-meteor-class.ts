const MeteorJarFilePath: string = "C:/Users/ohts1031ECW/AppData/Roaming/PrismLauncher/instances/vanila1.21/.minecraft/mods/meteor-client-0.5.8.jar";
const meteor: string = "meteordevelopment.meteorclient"
